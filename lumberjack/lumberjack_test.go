...
func TestDefaultFilename(t *testing.T) {
	currentTime = fakeTime
	dir := os.TempDir()
	filename := backupName(filepath.Join(dir, filepath.Base(os.Args[0])+"-lumberjack.log"), false)
...
func TestAutoRotate(t *testing.T) {
	...
	existsWithContent(secondFilename, b2, t)
...
func TestFirstWriteRotate(t *testing.T) {
	...
	firstFilename := backupFile(dir)
	start := []byte("boooooo!")
	err := ioutil.WriteFile(firstFilename, start, 0600)
	isNil(err, t)
	...
	existsWithContent(firstFilename, start, t)
...
func TestMaxBackups(t *testing.T) {
	...
	existsWithContent(thirdFilename, b3, t)
	...
	compLogFile := logFile(dir) + compressSuffix
...
func TestLocalTime(t *testing.T) {
	...
	isNil(err, t)
	equals(len(b2), n2, t)
	secondFilename := backupFileLocal(dir)
	existsWithContent(secondFilename, b2, t)
}
...
func TestRotate(t *testing.T) {
	...
	existsWithContent(firstFileName, b, t)
	existsWithContent(secondFileName, []byte{}, t)
	fileCount(dir, 2, t)
	newFakeTime()
	...
	existsWithContent(thirdFilename, []byte{}, t)
	existsWithContent(secondFileName, []byte{}, t)
	fileCount(dir, 2, t)
...
func TestCompressOnRotate(t *testing.T) {
	...
	err = gz.Close()
	isNil(err, t)
	existsWithContent(firstFilename+compressSuffix, bc.Bytes(), t)
	notExist(firstFilename, t)
